		...
		<div class="container">
			<div class="left-div">
				<div class="left-div-1">
					...
					<div class="mp_div_3">
						<label class="mp_div_3_label" id="mp_moist_perc">0.656</label> <label
							class="mp_div_3_label" id="mp_mat_Temp">0.83</label> <label
							id="mp_mat_density" class="mp_div_3_label">0.83</label> <input
